...
test-player: characters/Player.cpp races/Race.cpp styles/Style.cpp
	$(CC) $(CFLAGS) -o test-player characters/Character.cpp characters/Player.cpp races/Race.cpp races/Human.cpp styles/Style.cpp styles/Warrior.cpp items/Item.cpp items/Armor.cpp items/Potion.cpp items/Weapon.cpp
